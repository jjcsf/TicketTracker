...
app.post('/api/auth/register', async (req, res) => {
  try {
    ...
    (req.session as any).user = { username, email };
...
app.post('/api/auth/login', async (req, res) => {
  try {
    ...
    (req.session as any).user = { username: user.username, email: user.email };
...
app.get('/api/test', (req, res) => {
  res.json({ 
    ...
    users: users.size,
    session: !!(req.session as any).user
  });
});

// Static HTML content with proper MIME types
...
// Serve static content with proper headers
app.get('/', (req, res) => {
...
// Catch all routes to serve the app
app.get('*', (req, res) => {
