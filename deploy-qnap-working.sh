...
echo "Season Ticket Manager - QNAP LXD Deployment (Working Version)"
echo "=============================================================="
...
// Frontend HTML - using concatenation instead of template literals
...
"        setTimeout(function() { showDashboard(user); }, 1000);" +
"      }).catch(function(error) {" +
