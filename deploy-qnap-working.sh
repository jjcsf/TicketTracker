...
# Working QNAP LXD deployment with CommonJS
set -e
...
# Create package.json using CommonJS
...
# Create server using CommonJS syntax
...
if lxc exec "$CONTAINER_NAME" -- systemctl is-active --quiet season-ticket-manager; then
    ...
    echo ""
    echo "Your Season Ticket Manager is ready!"
else
